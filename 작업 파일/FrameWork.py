...
class 던파스카우터프레임워크:
    ...
    def 캐릭터설정하기Tk(self):
        ...
        캐릭터설정하기_Tk = Tk()
        캐릭터설정하기_Tk.geometry(Tk크기설명(400, 400, self.Tk_Position['x'] - 100, self.Tk_Position['y']))
        ...
        Tk버튼만들기(캐릭터설정하기_Tk, 12, 'bold', '저장하기', None, 110, 95)
        ...
        Tk글쓰기(캐릭터설정하기_Tk, 12, 'bold', '캐릭터장비사전', 235, 50)
        Tk출력창만들기(캐릭터설정하기_Tk, 10, 24, 23, '', 210, 75)
